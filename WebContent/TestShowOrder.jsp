...
<body>
	...
	<table border='1'>
	<thead>
	 <tr><th>维修单号</th><th>保修日期</th><th>维修状态</th><th>维修地点</th><th>故障类型</th><th>故障描述</th><th>故障图片</th><th>操作类型</th></tr> 
	 </thead>
	 <tbody>
	<%
	...
	for(int i=0;i<lenth;i++){
		...
		out.print("<tr><td>"+id+"</td>"+"<td>"+date+"</td>"+"<td>"+processInfo+"</td>"+"<td>"+addr+"</td>"+"<td>"+Type+"</td>"+"<td>"+BADInformation+"</td>"+"<td>"+BADimage+"</td>"+"<td>"+ProcessInform+"</td>");
